#!/usr/bin/env bash
# Warm anonymous home HTML after UI restart or page-cache invalidate.
...
NGINX_URL="${UI_PREWARM_NGINX_URL:-https://127.0.0.1/}"
...
if command -v curl >/dev/null 2>&1; then
  echo "=== prewarm nginx ($NGINX_URL Host=$HOST_HEADER) ==="
